...
{% block main %}
                ...
                <div class="row">
                        <div class="col-md-12 transparentBlackBg ui-shadow">
                                <div class="row">
                                	<div class="col-md-3">
                                		<h1>PHP5</h1>
                                	...
                                	<div class="col-md-3">                                	
										...
										<h1>jQuery</h1>
										<input type="text" class="ui-circular-progress" value="95" data-width="120" data-fgColor="#1eff00" data-readOnly="true">
                                	</div>
                                	<div class="col-md-3">     
										<h1>CSS3</h1>
