...
<script type="text/javascript" src="/lib/plugins/bootstrap-editable/js/wysiwyg.js"></script>
...
{% block main %}
    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="accordion ui-loadable" id="todoList" data-module="backend" data-controller="todo" data-action="list">                
