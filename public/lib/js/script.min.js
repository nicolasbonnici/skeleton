...
.each(function(){Ux
.loadScroll($(this));});}}
return false;});$('body').data('UxListened',true);}},registerListeners:function(){$('.ui-equalize-height')
.each(function(){$(this)
