...
oParams=$.extend($formTarget.data(),obj.data());oParams.parameters=$formTarget.serializeJSON();console.log(oParams.parameters);if($(sFormSelector+' div[contenteditable=true]').size()!=0){$(sFormSelector+' .ui-editor').each(function(){sInputName=$(this).data('name');sInputValue=$(this).parent().find('div[contenteditable=true]:first')
